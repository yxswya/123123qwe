    ...
    .guard({
        ...
        app
            .post('/start', async ({ body }) => {
                ...
                const result = await fetch('http://host.docker.internal:8002/api/data/governance/rag/train/from-files', {
                    method: 'POST',
                    body: formData,
                }).then(res => res.json())
                ...
                // const result = await fetch('http://host.docker.internal:8002/api/exec/train/start', {
                //     method: 'POST',
            ...
            .post('/evaluate', async () => {
                return fetch('http://host.docker.internal:8002/api/exec/train/evaluate', {
                    method: 'POST',
                    headers: {
