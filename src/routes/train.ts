    ...
    .guard({
        ...
        app
            .post('/start', async ({ body }) => {
                ...
                const result = await fetch('http://192.168.20.131:8002/api/data/governance/rag/train/from-files', {
                    method: 'POST',
                    body: formData,
                }).then(res => res.json())
                ...
                // const result = await fetch('http://192.168.20.131:8002/api/exec/train/start', {
                //     method: 'POST',
            ...
            .post('/evaluate', async () => {
                return fetch('http://192.168.20.131:8002/api/exec/train/evaluate', {
                    method: 'POST',
                    headers: {
