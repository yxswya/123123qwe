    ...
    .guard({
        ...
        app
            .post('/:sessionId', async ({ body, user, params: { sessionId } }) => {
                ...
                const data = await fetch('http://8.130.127.184:8002/api/governance/process/batch/enhanced', {
                    method: 'POST',
                    body: formData,
                })
                    .then(res => res.json())
            ...
            .post('/rag/:sessionId', async ({ body, user, params: { sessionId } }) => {
                ...
                const data = await fetch('http://8.130.127.184:8002/api/data/governance/rag/build/from-files', {
                    method: 'POST',
                    body: formData,
                })
                    .then(res => res.json())
